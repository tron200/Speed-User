...
//            foregroundPolyline = googleMap.addPolyline(optionsForeground);
    ...
    public void animateRoute(GoogleMap googleMap, List<LatLng> routePointList, Context mContext) {
        ...
        PolylineOptions optionsBackground = new PolylineOptions().add(routePointList.get(0)).color(GREY).width(dipToPixels(mContext, 3));
        backgroundPolyline = googleMap.addPolyline(optionsBackground);

        optionsForeground = new PolylineOptions().add(routePointList.get(0)).color(Color.BLACK).width(dipToPixels(mContext, 3));
        foregroundPolyline = googleMap.addPolyline(optionsForeground);
