...
public class DecodeRoute {
    ...
    public DecodeRoute(Context context, GoogleMap googleMap, String encodedPolyPoints) {
        ...
        this.polyz = decodePolyPoints(encodedPolyPoints);
    }
        ...
        googleMap.setOnMapLoadedCallback(new GoogleMap.OnMapLoadedCallback() {
            ...
            public void onMapLoaded() {
                ...
                if (destinationAddress != null) {
                    ...
                    TextView addressDes =  marker_view2.findViewById(R.id.addressTxt);
                    TextView etaTxt =  marker_view2.findViewById(R.id.etaTxt);
...
//                MapAnimator.getInstance().animateRoute(googleMap, polyz);
